...
const CareList = () => {
  ...
  return (
    <div className="text-[1.2rem]">
      ...
      <div className="flex flex-col mx-auto w-[35rem] md:w-[60rem] h-68 rounded-lg items-center bg-gray-100 ">
        <div className="flex flex-col md:flex-row mt-8 justify-around items-center">
          <div className="flex flex-col mr-1 md:mr-10 items-center">
        ...
        <div className="w-[15rem] ml-0 md:ml-[30rem] mt-10">
