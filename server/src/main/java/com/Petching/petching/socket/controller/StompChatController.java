package com.Petching.petching.socket.controller;

import com.Petching.petching.socket.dto.ChatMessageDto;
import com.Petching.petching.socket.mapper.ChatMessageMapper;
import com.Petching.petching.socket.repository.ChatMessageRepository;
import com.Petching.petching.socket.service.ChatRoomService;
import com.Petching.petching.socket.service.WebSocketSessionService;
import com.Petching.petching.room.service.RoomService;
import com.Petching.petching.room.service.RoomServiceTransient;
...
public class StompChatController {
    ...
    public void enterMember(@Payload ChatMessageDto message, SimpMessageHeaderAccessor headerAccessor) {
        ...
        repository.save(mapper.chatMessageDtoToChatMessage(message));
    ...
    public void webSocketDisconnectListener(SessionDisconnectEvent event) {
        ...
        if (nickname != null) {
            ...
            repository.save(mapper.chatMessageDtoToChatMessage(chat));
